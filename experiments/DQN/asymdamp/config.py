...
class config:
    ...
    logger_dir = '/Users/jadonng/Desktop/MarketMaking/log/Training/DQN/asymdamp'
    experiment_name = 'asymdamp_k1p5_sigma2'
    
    # RL config
    # N_ACTIONS=9
    N_ACTIONS=25 # discrete
    ...
    # TD Learning config
    model_path = '/Users/jadonng/Desktop/MarketMaking/models/DQN/asymdamp/'
    RLgamma=0.97
    epsilon=0.8
    min_epsilon=0.1
