...
class config:
    ...
    logger_dir = '/Users/jadonng/Desktop/MarketMaking/log/Training/DQN/invpen'
    experiment_name = 'invpen_k1p5_sigma2'
    ...
    # TD Learning config
    model_path = '/Users/jadonng/Desktop/MarketMaking/models/DQN/invpen/'
    RLgamma=0.97
    epsilon=0.8
    min_epsilon=0.1
