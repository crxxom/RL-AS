...
class config:
    ...
    logger_dir = '/Users/jadonng/Desktop/MarketMaking/log/SARSA/TC_utility'
    experiment_name = 'TC_utility_k1p5_sigma2'
    ...
    # TD Learning config
    model_path = '/Users/jadonng/Desktop/MarketMaking/models/SARSA/TC_utility/TC_utility'
    RLgamma=0.97
    epsilon=0.8
    min_epsilon=0.1
